...
export const en: Strings = {
  ...
  home: {
    ...
    valueLine: 'Have a question about the Dhamma? Find the answer in the source texts themselves.',
    askTitle: 'You might be asking—',
    askMore: 'See all questions',
    toolsLabel: 'Or use the tools directly',
  ...
  // Madhyama Āgama landing pages (/en/agama/[maId]). Shows the Chinese source text + deep link.
  agamaPage: {
    maPrefix: 'Madhyama Āgama ',
    maMid: ' · ',
    maSuffix: '',
    mnPrefix: 'MN ',
    mnSuffix: '',
    listSep: ', ',
    descA: 'Chinese source text of Madhyama Āgama sutta ',
    descB: ' (Taishō 26), the parallel of Majjhima Nikāya ',
    descC: '. Read it alongside a line-by-line vernacular study of the Pāli.',
    ledeA: 'This is the Chinese source text of Madhyama Āgama sutta ',
    ledeB: ' (Taishō 26), paralleling Majjhima Nikāya ',
    ledeC: '. The full Chinese text is below; open the paired sutta for a line-by-line vernacular study.',
    ctaLabel: 'Read the paired Majjhima Nikāya study',
    ctaLead: 'Study',
    originalHeading: 'Madhyama Āgama source text (Chinese)',
    srcNoteA: 'Source: ',
    srcNoteB: ' (Taishō 26, via CBETA, CC BY-NC-SA 3.0 TW; presented verbatim, unaltered)',
    footA: 'Want a line-by-line vernacular reading? Go to ',
    footB: '.',
    viewOriginal: 'View Āgama text',
  },
};
